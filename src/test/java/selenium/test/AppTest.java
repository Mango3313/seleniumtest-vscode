...
public class AppTest {
    ...
    @Test
    public void TC_001_HappyPath() throws InterruptedException {
    ...
    @Test
    public void TC_002_EmptyFields() throws InterruptedException {
        Actions actions = new Actions(driver);
        /* Indentify webelements on page */
        // name
        ...
        searchButton.sendKeys(Keys.ENTER);
        System.out.println("AppTest.EmptyFields()");
        try {
            driver.findElement(By.id("closeLargeModal"));
            System.err.println("Modal is present, expected to not be.");
    ...
    @Test
    public void TC_003_EmptyMandatoryFields() throws InterruptedException {
        // Set actions to perform operations over radio and check buttons
        Actions actions = new Actions(driver);
        /* Indentify webelements on page */
        // name
        ...
        WebElement searchButton = driver.findElement(By.id("submit"));
        searchButton.sendKeys(Keys.ENTER);
        System.out.println("AppTest.EmptyMandatoryFields()");
        try {
            driver.findElement(By.id("closeLargeModal"));
            System.err.println("Modal is present, expected to not be.");
        } catch (Exception exception) {
    ...
    @Test
    public void TC_004_DateBirthDay() throws InterruptedException {
    ...
    @Test
    public void TC_005_WrongName() throws InterruptedException {
        // Check if the title is correct
        // Set actions to perform operations over radio and check buttons
        Actions actions = new Actions(driver);
        /* Indentify webelements on page */
    ...
    @Test
    public void TC_006_WrongLastName() throws InterruptedException {
        // Check if the title is correct
        // Set actions to perform operations over radio and check buttons
        Actions actions = new Actions(driver);
        /* Indentify webelements on page */
    ...
    @Test
    public void TC_007_EraseInputs() {
        List<WebElement> testInputs = new ArrayList<WebElement>(Arrays.asList(
                inputFirstName, inputLastName, inputEmail, inputGender1, inputGender2,
                inputGender3, mobileNumber, dateOfBirth, subjectsInput, hobbiesInput1, hobbiesInput2, hobbiesInput3,
                pictureInput, addressInput, stateInput, cityInput));
        for (WebElement e : testInputs)
